...
$artistas = mysqli_real_escape_string($conexion, $artistas);


$sql = "UPDATE producto SET  nombre = '$nombre', descripcion = '$descripcion', artistas = '$artistas', imagen = '', idcategoria = $idcategoria, precio = $precio WHERE idproducto = $idproducto ;";
// echo $sql;
...
if (!$resultado) {
    ...
    responder(false, null, "Error al actualizar producto: " . mysqli_error($conexion), $conexion);
} else {
    ...
    if ($_FILES['imagen']['error'] != UPLOAD_ERR_OK) {
        switch ($_FILES['imagen']['error']) {
            ...
            case UPLOAD_ERR_NO_FILE:
                ...
                responder(true, null, "Producto actualizado, no la imagen", $conexion);
                break;
    ...
    //El image_id es el mismo que el idproducto
    $image_id = $idproducto;
    ...
    responder(true, null, "Producto actualizado y la imagen", $conexion);
}
