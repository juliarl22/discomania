...
$sql = "INSERT INTO categoria( idcategoria, nombre, descripcion, imagen) VALUES (null , '$nombre', '$descripcion', '')";
$resultado = mysqli_query($conexion, $sql) or die(mysqli_error($conexion));


if (!$resultado) {
    // responder($ok, $datos, $mensaje, $conexion)
    responder(false, null, "Error al registrar la categoría: " . mysqli_error($conexion), $conexion);
} else {
    ...
    if ($_FILES['imagen']['error'] != UPLOAD_ERR_OK) {
        switch ($_FILES['imagen']['error']) {
            ...
            case UPLOAD_ERR_NO_FILE:
                ...
                responder(true, null, "Categoría insertada sin imagen", $conexion);
                break;
    ...
    //el nuevo registro de categoria
    $image_id = mysqli_insert_id($conexion);
    ...
    responder(true, null, "Categoría insetyada con imagen", $conexion);
}
