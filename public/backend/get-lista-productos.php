...
$sql = "SELECT p.idproducto as portada, p.nombre, c.nombre as categoria,  p.artistas, p.descripcion,p.precio,p.idproducto FROM producto as p, categoria as c  WHERE p.idcategoria = c.idcategoria ORDER BY p.nombre ASC;";
